...
\newtext{After ACCs>10, ODP has already allocated enough ACCs in each application-specific platform (mentioned in \figref{fig:allsw}), there are no remaining kernels to accelerate, then ODP lines are identical in \figref{fig:sw12} and \figref{fig:sw19}.} 
