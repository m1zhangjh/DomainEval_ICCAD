...
To see how individual applications are affected by the allocation scheme, 
\figref{fig:sw12all} shows the cumulative probability of efficiency improvement with a ACCs=12 budget.
