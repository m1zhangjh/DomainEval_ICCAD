...
\newtext{
\figref{fig:exTime} shows the exploration time of MAAR DSE with different aggregations running on Intel i5-3450 with 3.10GHz. In \figref{fig:timeACCs}, the MAAR exploration time increases with the increasing of ACCs budget.  
...
With the number of applications increasing, the $A \mhyphen OOP$ and $M \mhyphen OOP$ exploration time increase much faster than $A \mhyphen SW$, $M \mhyphen SW$ and $Alog$. The reason is that the number of application OPT platform search dramatic increases the exploration time of $M \mhyphen OOP$ and $A \mhyphen OOP$. 
}
