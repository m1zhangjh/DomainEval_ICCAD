...
\newtext{
This section demonstrates the limits of composability of single application DSE. In \figref{fig:alloop}, the MAAR with a 2 ACCs budget allocates \emph{Custom Convlution} and \emph{Canny Edge Detector} kernels, and achieves 67\% the average energy efficiency of OOP, which uses 25 unique ACCs in OOP shown in \figref{fig:oopHW}. It means a MAAR accelerating a small number of high-computing kernels can achieve good energy efficiency across many applications.
}
